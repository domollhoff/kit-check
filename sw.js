...
/* Navigations: network first so a deployed update is picked up when online,
   cache fallback so the app opens in a garage with no signal.
   Everything else: cache first, since the shell is versioned by BUILD. */
